    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Compass
                        className="w-5 h-5 text-white/80 group-hover:text-white transition-colors duration-500"
                        strokeWidth={1}
                    />
                    <span className="font-serif text-lg tracking-[0.2em] text-white uppercase opacity-100 group-hover:opacity-80 transition-opacity">
                        Alpine Lift
                    </span>
                </motion.div>
